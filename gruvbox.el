...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light0))
     ...
     (org-level-1                               (:foreground gruvbox-bright_blue :family "DejaVu Sans" :height 1.4))
     (org-level-2                               (:foreground gruvbox-bright_yellow :family "DejaVu Sans" :height 1.2))
     (org-level-3                               (:foreground gruvbox-bright_purple :family "DejaVu Sans" :height 1.1))
     (org-level-4                               (:foreground gruvbox-bright_red :family "DejaVu Sans"))
     (org-level-5                               (:foreground gruvbox-bright_green :family "DejaVu Sans"))
     (org-level-6                               (:foreground gruvbox-bright_aqua :family "DejaVu Sans"))
     (org-level-7                               (:foreground gruvbox-faded_blue :family "DejaVu Sans"))
     (org-level-8                               (:foreground gruvbox-bright_orange :family "DejaVu Sans"))
